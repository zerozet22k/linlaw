...
const NewsletterDetailContent: React.FC = () => {
    ...
    // keep lang in navigation (same pattern as your AppMenu)
    ...
    const safeBack = useCallback(() => {
        // if user opened from google/share link, router.back() can bounce off-site
        try {
        ...
        router.push(withLang("/newsletters"));
    }, [router, withLang]);
    ...
    // optional: set actual tab title for UX (SEO handled server-side in page.tsx)
    useEffect(() => {
