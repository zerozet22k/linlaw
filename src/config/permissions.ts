...
export const APP_PERMISSIONS = {
  ...
  EDIT_RELATED_BUSINESS: "edit_related_business",
  DELETE_RELATED_BUSINESS: "delete_related_business",
...
export const PERMISSION_GROUPS: Record<string, AppPermissionType[]> = {
  ...
  ACCESS: [
    ...
    APP_PERMISSIONS.SEND_EMAIL,
  ],
  MANAGE_RELATED_BUSINESSES: [
    APP_PERMISSIONS.VIEW_RELATED_BUSINESSES,
...
export const PERMISSION_GUIDE: Record<AppPermissionType, string> = {
  ...
  [APP_PERMISSIONS.CREATE_RELATED_BUSINESS]:
    "Allows creating new related businesses.",
  [APP_PERMISSIONS.EDIT_RELATED_BUSINESS]:
    "Allows editing existing related businesses.",
  [APP_PERMISSIONS.DELETE_RELATED_BUSINESS]:
    "Allows deleting related businesses.",
};
