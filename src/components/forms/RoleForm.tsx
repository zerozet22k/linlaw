...
const RoleForm: React.FC<RoleFormProps> = ({ role }) => {
  ...
  const handleTogglePermission = (checked: boolean, perm: AppPermissionType) => {
    setSelectedPermissions((prev) => {
      const newSet = new Set(prev);
      if (checked) {
        if (FREE_PERMISSIONS.includes(perm) || userPermissions.includes(perm)) {
  ...
  const formTitle = role ? "Edit Role" : "Create Role";
                        ...
                        return (
                          ...
                          >
                            <Checkbox
                              ...
                              onChange={(e) =>
                                handleToggleGroup(e.target.checked, perms)
                              }
                                ...
                                return (
                                  <Col xs={24} sm={12} key={perm}>
                                    ...
                                    >
                                      <Checkbox
                                        checked={
                                          isFree ? true : selectedPermissions.includes(perm)
                                        }
                                        onChange={(e) =>
